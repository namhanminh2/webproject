            ...
            <div class="col-md-12">
                ...
                <form method="post" action="{{url('save-category')}}">
                    ...
                    <div class="md -3">
                        ...
                        <input type="text" class="form-control" name="category" placeholder="Enter PC Category">
                    </div>
                    @error('category')
                    ...
                    @enderror     
                    <div class="md -3">
                        <label class="form-lebel">Info Category</label>
                        <input type="text" class="form-control" name="info" placeholder="Enter Info Category">
                    </div>
                    @error('info')
                        <div class = "alert alert-danger" role = "alert"> 
                            {{$message}}
