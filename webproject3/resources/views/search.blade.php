                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                                 <a href="{{url('user-view-productDetail/'.$row->PCID)}}" >
                                 <figure><img width = "300px" height = "300px" src ="images/{{$row->PCImage1}}" alt="#"/></figure>
                                 <h3>{{$row->PCName}} {{$row->PCDetail}}</h3>
                                 <h2> Price : {{$row->PCPrice}} VND</h2>
                                 </a>                            
                           </div>
                        </div>
                        @endforeach
