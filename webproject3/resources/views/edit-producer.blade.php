    ...
    <div class="container" style="margin-top:20px">
        <div class ="row">
            <div class="col-md-12">
                ...
                @endif
                <form method="post" action="{{url('update-producer')}}">
                    @csrf
                    <div class="md -3">
                        <label class="form-lebel">Producer ID</label>
                        <input type="text" class="form-control" name="id" placeholder="Enter PC ID" value="{{$data->producerID}}" readonly>
                    </div>
                    @error('id')
                    ...
                    @enderror 
                    <div class="md -3">
                        <label class="form-lebel">Producer Name</label>
                        <input type="text" class="form-control" name="name" placeholder="Enter PC Name" value="{{$data->producerName}}">
                    </div> 
                    @error('name')
                        <div class = "alert alert-danger" role = "alert"> 
                            {{$message}}
                    ...
                    @enderror
                    <div class="md -3">
                        <label class="form-lebel">Producer Address</label>
                        <input type="text" class="form-control" name="address" placeholder="Enter PC Address" value="{{$data->producerAddress}}">
                    </div> 
                    @error('address')
                        <div class = "alert alert-danger" role = "alert">
                            {{$message}}
