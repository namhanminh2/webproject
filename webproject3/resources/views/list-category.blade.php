...
<html lang="en">
  ...
  <body>   
    ...
    <div class = "container" style="margin-top: 20px;">
        <div class = "row"> 
            <div class = "col-md-12">
                <h1 class="align-middle"> Category list </h1>
                ...
                <div style = "margin-right:10%; float:right;">
                    <a href="{{url('add-category')}}" class="btn btn-primary"> Add category</a> <!-- dung cai nay de goi toi trang web vd như /add-product-->
                </div>
                <table class = "table table-hover" style="justify-content: space-between">
                    ...
                    <tbody>
                        @foreach($data as $row)
                        <tr>
                            <td width = "10%" class = "midText">{{$row->categoryID}}</td>
                            <td width = "30%" class = "midText">{{$row->categoryName}}</td>
                            <td width = "40%" class = "midText">{{$row->categoryInfo}}</td>
                            <td width = "20%" class = "midText"><a href="{{url('edit-category/'.$row->categoryID)}}" class = "btn btn-primary">Edit</a>
                                <a href="{{url('delete-category/'.$row->categoryID)}}" class ="btn btn-danger" 
